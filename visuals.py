...
def plot_trials(csv):
    ...
    print "Statistics of Rolling Average Reward per Action:\n", step["average_reward"].describe()
    ###############
    ### Parameters Plot
    ###############
    ...
    print "Statistics of Rolling Relative Frequency of Bad Actions:\n", (1-actions["good"]).describe()
    print "Percentage of bad decisions cause accidents:\n", ((actions["minor_acc"] + actions['major_acc'])/(1- actions["good"])).describe()
